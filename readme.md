...
| `RETENA_PASSIVE_PRESENCE_HEARTBEAT`     | Allow only `unavailable` presence while passive listener mode blocks mutating routes | `false`                           | `RETENA_PASSIVE_PRESENCE_HEARTBEAT=true`      |
